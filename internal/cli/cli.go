...
func printUsage(output io.Writer) {
	...
	_, _ = fmt.Fprintln(output, "hostd update check [--manifest-url URL] [--proxy-url URL]")
	_, _ = fmt.Fprintln(output, "hostd update download [--manifest-url URL] [--proxy-url URL] [--output-dir DIR]")
	_, _ = fmt.Fprintln(output, "hostd update apply [--manifest-url URL] [--proxy-url URL] [flags]")
